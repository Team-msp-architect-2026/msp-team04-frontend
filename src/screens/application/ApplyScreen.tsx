  ...
  const filteredPrograms =
    filter === 'urgent'
      ? AVAILABLE_PROGRAMS.filter(
          p => p.urgency === 'urgent' || p.urgency === 'soon',
        )
      : AVAILABLE_PROGRAMS;
        ...
        <View style={s.filterRow}>
          ...
          >
            <Text
              style={[
                s.filterBtnText,
                filter === 'urgent' && s.filterBtnUrgentText,
              ]}
            >
              마감임박
            </Text>
                  ...
                  <View style={s.cardImageWrap}>
                    <View
                      style={[
                        ...
                        {
                          backgroundColor:
                            program.urgency === 'urgent'
                              ? '#FFE9E9'
                              : program.urgency === 'soon'
                                ? '#FFF9E6'
                                : '#EBF8FF',
                        },
                      ]}
                    ...
                    <View style={s.cardBottom}>
                      <View style={s.cardBottomLeft}>
                        ...
                        <Text style={s.cardLocation}>
                          {program.location.split(' ').slice(-1)}
                        </Text>
